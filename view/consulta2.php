...
<div style="width: 50%; margin: 0 auto;">
    <form action="cobertura.php" method="POST" autocomplete="on">
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">DEPARTAMENTO</label>
        <select name="departamento" required class="form-control" id="cod_depto">
    ...
    <div class="mb-3">
        ...
        <select name="municipio"  class="form-control" id="cod_munic" disable>
